#!/usr/bin/env python3
"""
Bridge node — normalises CarMaker simulation topics to clean internal topics.
On real hardware, swap this node out; nothing else in the pipeline changes.
...
class Bridge(Node):
    def __init__(self):
        ...
        self.get_logger().info(f'Bridge ready  {pc_in} → {pc_out}')
